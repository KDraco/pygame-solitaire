...
#main class for the new moving cards when you win
class AnimatedCard(Card):
    ...
    #keeps changing the position of the cards
...
#holds the functions for actually moving the cards when you win
class WinAnimator(object):
    ...
    #replaces the extisting cards with the new animated ones
    def setup(self):
